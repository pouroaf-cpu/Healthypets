...
## The best cat flea and worm treatment in NZ

For most NZ cats, the simplest cat flea and worm treatment is **Revolution Plus** — one monthly spot-on that covers fleas plus roundworm, hookworm and ear mites. If you also want tapeworm cover, **Broadline** handles fleas plus all three common worms in a single application. Here's the trap to dodge: "all-in-one" almost never means every parasite, and tapeworm — the one cats catch *from* fleas — is exactly the worm most combos quietly leave out.
